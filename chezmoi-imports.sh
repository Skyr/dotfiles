...
chezmoi import -r --strip-components 1 --destination ${HOME}/.oh-my-zsh-custom/powerlevel powerlevel10k-master.tar.gz
...
chezmoi import -r --strip-components 1 --destination ${HOME}/.oh-my-zsh-custom/plugins/fzf-tab fzf-tab-master.tar.gz
...
chezmoi import -r --strip-components 1 --destination ${HOME}/.oh-my-zsh-custom/plugins/zsh-syntax-highlighting zsh-syntax-highlighting-master.tar.gz
...
chezmoi import -r --strip-components 1 --destination ${HOME}/.oh-my-zsh-custom/plugins/zsh-autosuggestions zsh-autosuggestions-master.tar.gz
rm zsh-autosuggestions-master.tar.gz

mkdir -p ${HOME}/.oh-my-zsh
chezmoi add ${HOME}/.oh-my-zsh
curl -s -L -o oh-my-zsh-master.tar.gz https://github.com/robbyrussell/oh-my-zsh/archive/master.tar.gz
chezmoi import -r --strip-components 1 --destination ${HOME}/.oh-my-zsh oh-my-zsh-master.tar.gz
